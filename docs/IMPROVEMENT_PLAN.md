...
14. Pipeline для тестов/контрольных (`/course-maker test N`).
...
- Сейчас даты `2026-05-31` и `2026-06-13` — формально будущие.
- Если это сознательно (для тестов / для скрытия реальных дат) — оставить, добавить пометку.
- Иначе — выровнять с реальностью.
